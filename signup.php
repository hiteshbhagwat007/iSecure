...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($password == $c_password){
        // Inserting details
        $sql = "INSERT INTO users (name, username, email, password, tstamp) VALUES ('$name', '$username', '$email', '$password',  current_timestamp())";
...
<h1 class="text-3xl font-bold text-white mb-8 mt-10">Register Here to access</h1> 
<div class="h-auto mb-5 w-96 bg-gray-800 border border-white rounded-lg hover:shadow-lg hover:shadow-green-500/50">
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
            <button type="submit" class="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-500 rounded text-lg hover:shadow-lg hover:shadow-green-500/50">Register</button>
            </div>
